...
<<<<<<< Updated upstream
      ...
      <template v-else>
        ...
        <nav v-if="authStore.isAuthenticated" class="fixed bottom-0 w-full max-w-2xl bg-white border-t border-gray-200 flex justify-around p-3 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
          <router-link to="/" class="flex flex-col items-center text-gray-500 hover:text-indigo-600 transition-colors" :class="{ 'text-indigo-600': $route.path === '/' }">
            <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            <span class="text-xs font-medium">Feed</span>
          </router-link>

          <router-link to="/businesses" class="flex flex-col items-center text-gray-500 hover:text-indigo-600 transition-colors" :class="{ 'text-indigo-600': $route.path.startsWith('/businesses') }">
          ...
          <router-link to="/circles" class="flex flex-col items-center text-gray-500 hover:text-indigo-600 transition-colors" :class="{ 'text-indigo-600': $route.path.startsWith('/circles') }">
          ...
          <router-link to="/profile" class="flex flex-col items-center text-gray-500 hover:text-indigo-600 transition-colors" :class="{ 'text-indigo-600': $route.path === '/profile' }">
