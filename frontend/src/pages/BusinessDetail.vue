...
=======
    ...
    <div v-if="loading" class="space-y-4">
      <div class="bg-white rounded-xl shadow border border-gray-100 p-6 animate-pulse">
...
=======
      ...
      <div class="p-6 space-y-4">
        ...
        <p class="text-gray-700 leading-relaxed">{{ business.description || business.shortDescription }}</p>
